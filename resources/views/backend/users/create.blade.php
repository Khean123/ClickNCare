...
<div style="margin-bottom: 15px;">
    ...
    <select id="role" name="role" style="padding: 8px; width: 100%; border-radius:30px;" required>
        <option value="doctor" {{ old('role', isset($user) ? $user->role : '') == 'doctor' ? 'selected' : '' }}>Doctor</option>
