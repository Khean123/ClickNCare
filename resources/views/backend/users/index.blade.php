        ...
        <tr>
            ...
            <td>
                <div class="cardHeader" style="justify-content: space-evenly;">
                    <a href="{{ route('users.edit', $user->id) }}" class="btn btn-sm btn-primary"style="background-color: orange;">Edit</a>
...
<div style="margin-bottom: 15px;">
        ...
        <input type="text" id="role" name="role" style="padding: 8px; width: 100%; border-radius:30px;" required>
        @error('role')
